        ...
        .render(t, area, |t, chunks| {
            ...
            .render(t, &chunks[0], |t, chunks| {
                ...
                .block(Block::default()
                    ...
                    .title_style(Style::default().fg(Color::Green).modifier(Modifier::Bold)))
                .wrap(true)
                .text("\nI am a Software and hardware developer interested in {mod=bold Artificial intelligence} and {mod=bold Systems Programming}.\n\n\
                       I am a regular attendee of the {mod=bold C++} and {mod=bold Go} MeetUps in Varazdin and Zagreb.\n\n\
                       I have more then 10 years professional experiances in industry.\n\n\
                       ...
                       I enjoy playing all sorts of {mod=bold board games}, like {mod=Dungeons and Dragons}, and {mod=bold videogames}.\n\n\
                      ")
                .render(t, &chunks[1]);
            });
            Group::default()
...
fn draw_experience(t: &mut Terminal<RawBackend>, area: &Rect) {
    Group::default()
        ...
        .render(t, area, |t, chunks| {
                ...
                .block(Block::default()
                    .borders(Borders::ALL)
                    .title("2019 - Present: Senior Software Engineer at Asgard Technology, Pasadena, Ca, USA")
                    .title_style(Style::default().fg(Color::Green).modifier(Modifier::Bold)))
                .wrap(true)
                ...
                .block(Block::default()
                    .borders(Borders::ALL)
                    .title("2017 - 2018: Software Engineer at RedSky, Dubai, UAE")
                    .title_style(Style::default().fg(Color::Green).modifier(Modifier::Bold)))
                .wrap(true)
                ...
                .block(Block::default()
                    .borders(Borders::ALL)
                    .title("2015 - 2016: Softwrae analyst at HT, Deutsch telkekom group, Zagreb, Croatia")
                    .title_style(Style::default().fg(Color::Green).modifier(Modifier::Bold)))
                .wrap(true)
                ...
                .block(Block::default()
                    .borders(Borders::ALL)
                    .title("2005 - 2011: Linux kernel developer")
                    .title_style(Style::default().fg(Color::Green).modifier(Modifier::Bold)))
                .wrap(true)
